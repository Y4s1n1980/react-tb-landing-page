...
export const cs = {
  ...
  description:
    "Con nuestro bootcamp adquirirás los conocimientos para ser miembro de un equipo Red Team o Blue Team utilizando las estrategias y herramientas más actuales, en uno de los mejores programas del mundo en 2021.",
...
export function Containers({ course }) {
  return (
    <div>
      <img className="card-image" src={course.img}></img>
